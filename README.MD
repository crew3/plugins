...
# [What is a Zealy Plugin?](#section-1) 
A Zealy plugin is configured through a JSON file which includes: :plug:
...
- New Plugin Folder: Your PR should include a new folder within the plugins directory. This folder should be named after your plugin. :folder:
...
- Testing the plugin for functionality and reliability :tick mark:
